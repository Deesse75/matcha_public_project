...
export const appRoute = {
  ...
  deleteAccount: `${PATH}/auth/delete_account`,
  ...
  updateFirstname: `${PATH}/user/update_firstname`,
  updateLastname: `${PATH}/user/update_lastname`,
  updateUsername: `${PATH}/user/update_username`,
  updateEmail: `${PATH}/user/update_email`,
  updateValideEmail: `${PATH}/user/update_validate_email`,
  updatePassword: `${PATH}/user/update_password`,
  updateProfile: `${PATH}/user/update_profile`,
};
...
export const appRedir = {
  ...
  signout: '/deconnexion',
  delete: '/suppression',
  deleteAccount: '/suppression_compte',
